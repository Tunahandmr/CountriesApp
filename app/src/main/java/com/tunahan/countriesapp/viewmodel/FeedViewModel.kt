...
import com.tunahan.countriesapp.service.CountryDatabase
import com.tunahan.countriesapp.util.CustomSharedPreferences
...
class FeedViewModel(application: Application) : BaseViewModel(application) {
    ...
    private fun storeInSQLite(list: List<Country>){
        ...
        launch {
            ...
            val listLong = dao.insertAll(*list.toTypedArray()) //list->individual form
            var i = 0
            while (i<list.size){
